...
## Kokkoro、Core 和 Chobits 有什么区别？ {#what-is-the-difference-between-kokkoro-core-and-chobits}
...
Core 不会猜测参数代表数字、布尔值或其他类型。插件可以根据自己的业务规则完成转换和校验，详情参阅 [指令参数](/develop/command#argument-types)。
