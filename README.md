...
| **[kokkoro-plugin-animetrace](./plugins/animetrace)** | 使用 AnimeTrace 识别角色及所属作品         |
...
文档位于 [`docs`](./docs)，可以在该目录运行 `bun run dev` 启动本地开发服务。
